...
export const Reserve = ({setOpenSlider, hotelId}) => {
  ...
  return (
    <div className='reserve'>
        <div className="rContainer">
            <FontAwesomeIcon icon={faCircleXmark} className='rClose' onClick={()=>setOpenSlider(false)}/>
            <span className='rText'>Select your rooms:</span>
            {data.map(item=> (
                <div className="rItem">
